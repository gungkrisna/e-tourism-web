...
if (isset($_POST['submit'])) {
    ...
    if (empty($identity) || empty($password)) {
        ...
        if (filter_var($identity, FILTER_VALIDATE_EMAIL)) {
            ...
            $stmt->execute([(substr($identity, 0, 1) === '@') ? substr($identity, 1) : $identity]);
            $user = $stmt->fetch();
        }
...
<body>
    <div class="app app-auth-sign-in align-content-stretch d-flex flex-wrap justify-content-end">
        ...
        <div class="app-auth-container">
            ...
            <p class="auth-description">Masuk dengan akun E-Tourism Anda. Tidak punya akun? <a href="../signup">Buat akun</a></p>
            ...
            <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
                <div class="auth-credentials m-b-xxl">
                    <label for="signInIdentity" class="form-label">Akun</label>
                    <input type="text" name="identity" class="form-control m-b-md" id="signInIdentity" aria-describedby="signInIdentity" placeholder="Alamat email atau username" required>

                    <label for="signInPassword" class="form-label">Kata sandi</label>
                    <input type="password" name="password" class="form-control" id="signInPassword" aria-describedby="signInPassword" placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;" required>
                </div>
