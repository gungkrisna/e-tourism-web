      ...
      e.exports = (function () {
        ...
        var e = {
          en: {
            ...
            email: "Mohon masukkan alamat e-mail yang valid",
            number: "Bidang ini harus berisi angka",
            integer: "Bidang ini harus berisi bilangan bulat",
            url: "Bidang ini harus berisi URL situs web yang valid",
            tel: "Bidang ini harus berisi nomor telepon yang valid",
            maxlength: "Panjang bidang ini harus kurang dari ${1}",
            minlength: "Panjang bidang ini harus lebih dari ${1}",
            min: "Nilai minimum untuk bidang ini adalah ${1}",
            max: "Nilai maksimum untuk bidang ini adalah ${1}",
            pattern: "Mohon sesuaikan dengan format yang diminta",
            equals: "Dua bidang ini tidak cocok",
          },
        };
        function t() {
          var e = arguments;
      ...
      function tr(e, t) {
        ...
        function z() {
          "object" != typeof n.config.locale &&
            ...
            (Xo.K = `(${n.l10n.amPM[0]}|${n.l10n.amPM[1]
