...
if (isset($_POST['submit'])) {
    ...
    if (empty($nama) || empty($email) || empty($password)) {
        ...
        if ($user) {
            ...
            $_SESSION['success'] = 'Pendaftaran berhasil. Silahkan masuk menggunakan akun Anda.';
...
<head>
    ...
    <meta name="description" content="E-Tourism">
    <meta name="keywords" content="social media">
    <meta name="author" content="gk">

    <title>Daftar - E-Tourism</title>
    ...
    <link href="../dashboard/assets/plugins/perfectscroll/perfect-scrollbar.css" rel="stylesheet">
    <link href="../dashboard/assets/plugins/pace/pace.css" rel="stylesheet">
...
<body>
        ...
        <div class="app-auth-container">
            ...
            <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
                <div class="auth-credentials m-b-xxl">
                    ...
                    <input type="text" name="nama" class="form-control m-b-md" id="signUpName" aria-describedby="signUpName" placeholder="John Doe" required>

                    <label for="signUpEmail" class="form-label">Email</label>
                    <input type="email" name="email" class="form-control m-b-md" id="signUpEmail" aria-describedby="signUpEmail" placeholder="hi@E-Tourism.com" required>

                    <label for="signUpPassword" class="form-label">Kata sandi</label>
                    <input type="password" name="password" class="form-control" id="signUpPassword" aria-describedby="signUpPassword" placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;" required>
                </div>
    ...
    <script src="../dashboard/assets/plugins/perfectscroll/perfect-scrollbar.min.js"></script>
