...
<head>
  ...
  <title>Daftar Listing - E-Tourism</title>
  <!-- Favicon -->
          ...
          <div class="col-xl-6 offset-xl-1">
            <form action="create/" method="POST" id="jsForm" enctype="multipart/form-data">
              ...
              <fieldset class="rlr-product-form--hide start" data-attr="js-step-3">
                <!-- Section heading -->
                <div class="rlr-section__heading">
                  <h2 class="rlr-section__heading--main">Tambah ketentuan layanan</h2>
    ...
    <div class="container">
      ...
      <div class="rlr-footer__menu">
        ...
        <nav class="rlr-footer__menu__col rlr-footer__menu__col--lg">
          ...
          <p>Dapatkan informasi terbaru tentang destinasi perjalanan impian Anda.</p>
