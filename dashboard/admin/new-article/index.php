...
<head>
    ...
    <!-- Title -->
    <title>Buat Artikel - E-Tourism</title>
                            ...
                            <div class="container-xxl bg-white p-5" style="border-radius: var(--spacing-8);">
                                <article class="rlr-article rlr-article-single--v2">
                                    <header class="rlr-article__header">
                                        <div class="rlr-article__header__timestamp">Diterbitkan <?= $tanggal ?> oleh <?= $user['nama'] ?>
                                        </div>
                                        <h1 class="type-h1" id="blogTitle" placeholder="Tuliskan judul yang menarik" contenteditable="true" style="outline: none;"></h1>
                                        <h6 class="type-sub-title" id="blogSubtitle" placeholder="Sampaikan gambaran umum tentang apa yang akan Anda sampaikan dengan singkat disini." contenteditable="true" style="outline: none;"></h6>
                                    </header>
